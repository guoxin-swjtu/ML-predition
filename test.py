...
print('SVM精确率: ', precision_score(Y_test, y_predict, average='weighted'))
print('SVM召回率: ', recall_score(Y_test, y_predict, average='weighted'))
print('SVMacc: ', accuracy_score(Y_test, y_predict))
